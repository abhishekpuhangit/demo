...
if(isset($_POST['mobile'])){
   ...
   $competition_id = $_POST['competition_id'];
    ...
    $image_type=str_replace(" ", "_", $_FILES['image_type']['name']);
        ...
        $image_typetarget="individual_entry/".$image_type;
        move_uploaded_file($image_typesource, $image_typetarget);
        $image_type_url="https://daajyu.app/curiosityApi/".$image_typetarget;


		
		$query="INSERT into individual_entry_list(user_type,mobile,competition_id,image_type,timestamp) VALUES ('".$user_type."','".$mobile."','".$competition_id."','".$image_type."','".$date."')";
