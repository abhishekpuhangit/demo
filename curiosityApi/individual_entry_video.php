	...
	if(isset($_POST['mobile'])){
      ...
      $mobile = $_POST['mobile'];
	   ...
	   $competition_id = $_POST['competition_id'];
		...
		$videotarget="individual_entry/".$video;
		...
		if($filesize < 20971520){
			...
			$query="INSERT into individual_entry_list(user_type,mobile,competition_id,video_type,timestamp) VALUES ('".$user_type."','".$mobile."','".$competition_id."','".$video."','".$date."')";
